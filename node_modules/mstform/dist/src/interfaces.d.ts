...
export interface IFormAccessor<D extends FormDefinition<M>, G, M extends IAnyModelType> extends IAccessor {
...
export interface ISubFormAccessor<D extends FormDefinition<M>, G, M extends IAnyModelType> extends IFormAccessor<D, G, M> {
    name: string;
}
export interface IRepeatingFormAccessor<D extends FormDefinition<M>, G, M extends IAnyModelType> extends IAccessor {
    length: number;
...
export interface IRepeatingFormIndexedAccessor<D extends FormDefinition<M>, G, M extends IAnyModelType> extends IFormAccessor<D, G, M> {
    index: number;
    setIndex(index: number): void;
    setAddMode(addModeDefaults: string[]): void;
}
export declare type IParentAccessor = IFormAccessor<any, any, any> | IRepeatingFormAccessor<any, any, any> | undefined;
export declare type IAnyRepeatingFormIndexedAccessor = IRepeatingFormIndexedAccessor<any, any, any>;
export declare type IAnyRepeatingFormAccessor = IRepeatingFormAccessor<any, any, any>;
