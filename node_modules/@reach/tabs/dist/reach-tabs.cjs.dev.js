...
var Tabs = /*#__PURE__*/utils.forwardRefWithAs(function Tabs(_ref, ref) {
  ...
  var id = (_props$id = props.id) != null ? _props$id : utils.makeId("tabs", _id); // We only manage focus if the user caused the update vs. a new controlled
  // index coming in.
  ...
  var _useControlledState = utils.useControlledState(controlledIndex, defaultIndex != null ? defaultIndex : 0),
...
var TabListImpl = /*#__PURE__*/utils.forwardRefWithAs(function TabList(_ref2, forwardedRef) {
  ...
  utils.useIsomorphicLayoutEffect(function () {
    ...
    // index value.
    if (!isControlled && utils.boolOrBoolString((_tabs$selectedIndex = tabs[selectedIndex]) == null ? void 0 : _tabs$selectedIndex.disabled)) {
