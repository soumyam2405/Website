...
var SliderInput = /*#__PURE__*/utils.forwardRefWithAs(function SliderInput(_ref2, forwardedRef) {
  ...
  var handleSlideStart = utils.useEventCallback(function (event) {
    ...
    var ownerDocument = utils.getOwnerDocument(sliderRef.current);
  ...
  var addStartListener = React.useCallback(function () {
    ...
    var ownerDocument = utils.getOwnerDocument(sliderElement);
    var ownerWindow = ownerDocument.defaultView || window;
    ...
    var pointerListener = utils.wrapEvent(appEvents.current.onPointerDown, setPointerCapture);
...
var SliderRangeImpl = /*#__PURE__*/utils.forwardRefWithAs(function SliderRange(_ref4, forwardedRef) {
...
var SliderRange = /*#__PURE__*/utils.memoWithAs(SliderRangeImpl); // TODO: Remove in 1.0

var SliderTrackHighlightImpl = /*#__PURE__*/utils.forwardRefWithAs(function SliderTrackHighlightImpl(props, ref) {
